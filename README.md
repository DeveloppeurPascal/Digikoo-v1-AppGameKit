...
This project is open as an archive. The production version of Digikoo is now developed in Delphi and available on this code repository.
...
If you detect any anomalies on earlier versions, please don't hesitate to [report them](https://github.com/DeveloppeurPascal/Digikoo-v1-AppGameKit/issues) so that I can test and try to correct or provide a workaround.
