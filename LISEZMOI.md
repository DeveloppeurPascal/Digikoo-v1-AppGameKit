...
Si vous détectez des anomalies sur des versions antérieures n'hésitez pas à [les rapporter](https://github.com/DeveloppeurPascal/Digikoo-v1-AppGameKit/issues) pour que je teste et tente de corriger ou fournir un contournement.
